export const calculateTime = (inputDateStr) => {
    ...
    // Checks if it's today, tomorrow, or more than one day ago
    if (
        ...
        // Today: Converting to AM/PM format
        ...
        // More than 7 days ago: Shows date in DD/MM/YYYY format
